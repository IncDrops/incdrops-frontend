...
export default function IncDropsLanding({ onNavigate }) {
  ...
  return (
    <div className="bg-black text-white min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="text-gray-200"> Drop by drop, </span>
      ...
      {/* Auto-Scrolling Content Types Section */}
      <section 
        id="features"
      ...
      {/* Industries Vertical Carousel Section */}
      <section 
        id="industries"
            ...
            <div className="bg-gradient-to-br from-gray-400 via-gray-300 to-gray-500 rounded-2xl p-8 shadow-xl shadow-gray-700/50 hover:shadow-2xl hover:shadow-gray-600/50 transition-all duration-300 hover:scale-105">
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start text-gray-800">
                  <Check className="mr-3 mt-1 flex-shrink-0 text-gray-700" size={20} />
      ...
      <footer className="border-t border-gray-800 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-gray-300 via-gray-100 to-gray-400 bg-clip-text text-transparent">
                IncDrops
              </h3>
              <p className="text-gray-400 leading-relaxed mb-6">
                Never run out of content ideas. AI-powered ideation for modern creators.
              </p>
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © 2025 IncDrops. All rights reserved.
            </p>
